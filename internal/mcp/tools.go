	...
	return []toolDef{
		{
			...
			InputSchema: obj(map[string]any{
				...
				"packages":    strArr("package purls involved, e.g. pkg:npm/axios@1.12.0. A command is addressed as a CLI subject reference instead of a purl, e.g. cli:gh@2.40.0/workflow/run?opt=--ref&os=linux&arch=x64&shell=bash"),
