...
func TestPGActivityBucketsIdempotenceOwnerExclusionAndRetention(t *testing.T) {
	...
	// The walk is anchored the same way it is, by activityTestMonth, which every
	// month fixture in this file goes through so no call site can drift back to
	// a day-preserving AddDate.
	for age := 0; age <= 12; age++ {
