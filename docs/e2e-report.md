...
Run: 2026-08-13 09:26 UTC — server: docker compose e2e stack, client: csx.exe (windows/amd64), peers: 2

| Scenario | Result |
|----------|--------|
| A - automatic evidence | FAIL |
| B - failure evidence | PASS |
| D - sample contribution + cross verify | FAIL |
| C - search + reuse | PASS |
| E - private protection | PASS |
| F - outage resilience | FAIL |
...
- D: final sample status = PUBLISHED
