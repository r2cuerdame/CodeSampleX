...
| `doctor` | 로컬 설치 진단; `--fix`로 CSX 소유 상태를 안전하게 복구하고 재검증 |
...
코드: Apache-2.0. 게시된 샘플의 기본 라이선스는 **MIT-0**입니다. Evidence 및 집계된 호환성 데이터: **CDLA-Permissive-2.0** ([DATA_TERMS.md](../../DATA_TERMS.md) 참조).
