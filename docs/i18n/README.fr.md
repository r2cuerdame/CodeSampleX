...
Code : Apache-2.0. Les échantillons publiés sont par défaut sous **MIT-0**. Evidence et données de compatibilité agrégées : **CDLA-Permissive-2.0** (voir [DATA_TERMS.md](../../DATA_TERMS.md)).
